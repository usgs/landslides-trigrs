...
!	By R.L. Baum and W.Z. Savage, USGS, May 2004, latest revision 29 Jan 2013, RLB 
	subroutine pstpi(u1,dhwt,dwt,&
        & ulog,i,iper,rf,t0,jf) ! 1/29/2013 RLB 
...
!  	    if (flag==-3) write(u1,'(6(g12.5,1x):)') z,p(j),fs,thz(j) ! added 4/14/2010 RLB, substituted thz for chi 8/22/13, RLB
...
!	      if (flag<=-7 .and. flag>=-9) call svxmdv(i,jf,dh,newdep,ulog)  ! Added 2/10/2012
!	    end if
	  end if
	return
